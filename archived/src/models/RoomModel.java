...
public class RoomModel
{
    ...
    private final RoomEnum type;                        // The room type.
     ...
     */
    public RoomModel(int num, RoomEnum type, double nightlyPrice)
    {
        this.num = num;
        this.type = type;
    ...
    public void setNightlyPrice(double basePrice)
    {
        double rate = switch (this.type)
            {
                case RoomEnum.STANDARD  -> 1;
                case RoomEnum.DELUXE    -> 1.2;
                case RoomEnum.EXECUTIVE -> 1.35;
            };
